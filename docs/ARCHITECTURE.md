...
**Reference implementation:** 0.3.0; engineering reference, not production certification
...
| G7 Production | Independent review, owners, trust/key custody, backup restore, rolling upgrade, SLOs and failure drills | NO_GO |
