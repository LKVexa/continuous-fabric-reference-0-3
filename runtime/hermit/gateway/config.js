...
function publicConfig(cfg) {
  return { protocol: 'hermit.vws.v2', profile: cfg.profile, wsPath: '/ws/terminal', ticketPath: '/api/ws-ticket', auth: cfg.auth === 'none-loopback-dev' ? 'none' : 'bearer-ticket',
    build: cfg.cfp ? { name: 'Continuous Fabric Reference', version: require('../../../package.json').version, terminalVersion: require('../package.json').version } : null,
    capabilities: { resume: false, browserPane: false, virtualCommands: true, fabric: !!cfg.fabric, cfp: !!cfg.cfp },
